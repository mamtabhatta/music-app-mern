            ...
            <form className="upload-form" onSubmit={handleSubmit}>
                <div className="file-inputs-container">
                    <div className="file-box">
                        ...
                        <input id="song-upload" type="file" name="song" accept="audio/*" onChange={handleFileChange} hidden />
                    </div>
                    ...
                    <div className="file-box">
                        ...
                        <input id="cover-upload" type="file" name="cover" accept="image/*" onChange={handleFileChange} hidden />
                    </div>
                </div>

                <div className="text-inputs">
                    <input type="text" name="title" placeholder="Song Title" onChange={handleInputChange} required />
                    <input type="text" name="album" placeholder="Album Name (Optional)" onChange={handleInputChange} />
                    <input type="text" name="genre" placeholder="Genre (e.g. Pop, Jazz)" onChange={handleInputChange} />
                    <input type="text" name="duration" placeholder="Duration (e.g. 3:45)" onChange={handleInputChange} />
                </div>
